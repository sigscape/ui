      ...
      {open &&
        ...
        createPortal(
          <div
            ...
            className={cn(
              "pointer-events-none z-[120] block max-h-[60vh] w-max min-w-48 max-w-sm overflow-y-auto rounded-lg border border-border bg-popover p-3 text-xs font-normal normal-case leading-relaxed tracking-normal text-foreground shadow-lg",
